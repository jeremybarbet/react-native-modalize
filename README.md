### ⚠️ This `v3` branch is a work in progress to migrate to reanimated and simplify the overall API of the library. Check out `master` for the current version published on npm.
